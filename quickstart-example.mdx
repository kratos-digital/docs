---
title: "Quickstart"
description: "Start building awesome app in under 5 minutes"
---
...
Before getting started, make sure you have `PHP 8.3.x` or greater, `Node.js 21+`, `Nginx` or `Apache` server, and (optionaly) database service such as `MySQL`, `Postgres`, `MongoDB`, ...
